from src.utils.all_utils import AllPath,ClientImageInput,ClientImageOutput
...
Pathmodellabelmap = AllPath.get_all_file_path(os.path.join("config",'config_path.yaml'))
class ClientApp(IOR):
